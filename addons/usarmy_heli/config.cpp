...
//'now' is Sun Aug 18 23:27:16 2019 : 'file' last modified on Sun Aug 18 23:26:24 2019
...
class CfgVehicles
{
	...
	class AP_CH53: CH_series
	{
		...
		class Turrets
		{
			...
			class RearDoor_Gun: LeftDoor_Gun
			{
				...
				gunnerInAction = "LowTripod_Gunner";
				weapons[] = {"M134"};
				magazines[] = {"4000Rnd_762x51_M134","4000Rnd_762x51_M134"};
				ejectDeadGunner = 1;
				minElev = -45;
				maxElev = 15;
				initElev = 0;
	...
	class AP_CH34: CH_series
	{
		...
		class Sounds: Sounds
		{
			...
			class EngineIn
			{
				sound[] = {"ca\sounds\air\uh1y\int\int-fly-mode7",3.1622777,4};
				frequency = "(randomizer*0.05+0.08)*rpm";
				volume = "(1-camPos)*((rotorSpeed-0.75)*4)";
			};
			class RotorsIn
