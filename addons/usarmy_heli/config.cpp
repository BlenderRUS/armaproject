...
class CfgVehicles
{
	...
	class CH_series: Helicopter
	{
		...
		soundEngineOnInt[]=
		{
			"\USArmy_Heli\Sounds\ch53windupin.wss",
			0.5,
			1
		};
		soundEngineOnExt[]=
		{
			"\USArmy_Heli\Sounds\ch53_startup_ext.wss",
			0.69999999,
			1,
			400
		};
		soundEngineOffInt[]=
		{
			"\USArmy_Heli\Sounds\ch53_shutdown_int.wss",
			0.5,
			1
		};
		soundEngineOffExt[]=
		{
			"\USArmy_Heli\Sounds\ch53_shutdown_ext.wss",
			0.69999999,
			1,
			400
		};
		class Sounds: Sounds
		{
			class engineout
			{
				sound[]=
				{
					"\USArmy_Heli\Sounds\ch53_engine.wss",
					2.5118899,
					1,
					500
				};
			...
			class RotorHighOut
			{
				sound[]=
				{
					"\USArmy_Heli\Sounds\ch53_rotors.wss",
					6,
					1,
					3000
				};
			...
			class EngineIn
			{
				sound[]=
				{
					"\USArmy_Heli\Sounds\ch53_int.wss",
					"db10",
					2
				};
				frequency="rotorSpeed*0.98";
			...
			class rotors_in
			{
				sound[]=
				{
					"\USArmy_Heli\Sounds\ch53_rotors_int.wss",
					6,
					1
				};
				frequency="rotorSpeed*0.98";
	...
	class AP_CH46: CH_series
	{
		...
		minMainRotorDive=-6;
		maxMainRotorDive=10;
		neutralMainRotorDive=-2.5999999;
		minBackRotorDive=-10;
		maxBackRotorDive=6;
		neutralBackRotorDive=-2.5999999;
		gearRetracting=1;
		...
		class Damage
		{
			...
			mat[]=
			{
				"usarmy_heli\data\CH46\ch46main.rvmat",
				"usarmy_heli\data\CH46\ch46main_damage.rvmat",
				"usarmy_heli\data\CH46\ch46main_destruct.rvmat",
				"usarmy_heli\data\rst.rvmat",
				"usarmy_heli\data\rst_damage.rvmat",
				"usarmy_heli\data\rst_damage.rvmat"
			};
		};
		weapons[]=
		...
		{
			"usarmy_heli\data\CH46\ch46_main_co.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"USArmy_Heli\Num\decal\U.S.ARMYb.paa",
			"USArmy_Heli\Num\logo\LOGO_USAF.paa"
		};
		...
		class MarkerLights
		{
			class RedStill
			{
				...
				ambient[]={0.30000001,0.029999999,0.029999999,1};
			...
			class RedBlinking
			{
				...
				color[]={1,0.050000001,0.050000001,1};
				ambient[]={0.2,0.02,0.02,1};
				brightness=0.0099999998;
				blinking=1;
			};
	...
	class AP_CH46_M: AP_CH46
	{
		...
		hiddenSelectionsTextures[]=
		{
			...
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"USArmy_Heli\Num\decal\MARINESg.paa",
			"USArmy_Heli\Num\logo\LOGO_USAFg.paa"
		};
		class EventHandlers: DefaultEventHandlers
		{
	...
	class AP_CH46_M_G: AP_CH46
	{
		...
		hiddenSelectionsTextures[]=
		{
			"usarmy_heli\data\CH46\ch46_mainG_co.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"USArmy_Heli\Num\decal\MARINESb.paa",
			"USArmy_Heli\Num\logo\LOGO_USAFb.paa"
		};
		class EventHandlers: DefaultEventHandlers
		{
			init="_this execVM '\USArmy_Heli\Num\script\Num_Black.sqf';";
	...
	class AP_CH46_NAVY: AP_CH46
	{
		...
		hiddenSelectionsTextures[]=
		{
			...
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"USArmy_Heli\Num\decal\NAVYg.paa",
			"USArmy_Heli\Num\logo\LOGO_USAFg.paa"
		};
		class EventHandlers: DefaultEventHandlers
		{
	...
	class AP_CH46_NAVY_G: AP_CH46
	{
		...
		hiddenSelectionsTextures[]=
		{
			...
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"USArmy_Heli\Num\decal\NAVYB.paa",
			"USArmy_Heli\Num\logo\LOGO_USAFB.paa"
		};
		class EventHandlers: DefaultEventHandlers
		{
	...
	class AP_CH46_NAVY_B: AP_CH46
	{
		...
		hiddenSelectionsTextures[]=
		{
			"usarmy_heli\data\CH46\ch46_mainB_co.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"usarmy_heli\data\CH46\ch46_main_ti_ca.paa",
			"USArmy_Heli\Num\decal\NAVYW.paa",
			"USArmy_Heli\Num\logo\LOGO_USAFW.paa"
		};
		class EventHandlers: DefaultEventHandlers
		{
	...
	class AP_CH53: CH_series
	{
		...
		class Damage
		{
			...
			mat[]=
			{
				"usarmy_heli\data\CH53\ch53main.rvmat",
				"usarmy_heli\data\CH53\ch53main_damage.rvmat",
				"usarmy_heli\data\CH53\ch53main_destruct.rvmat",
				"usarmy_heli\data\rst.rvmat",
				"usarmy_heli\data\rst_damage.rvmat",
				"usarmy_heli\data\rst_damage.rvmat"
			};
		...
		hiddenSelectionsTextures[]=
		{
			"usarmy_heli\data\CH53\ch53main_co.paa",
	...
	class AP_CH53_M_G: AP_CH53
	{
		...
		hiddenSelectionsTextures[]=
		{
			"usarmy_heli\data\CH53\ch53mainG_co.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"USArmy_Heli\Num\decal\MARINESb.paa",
			"USArmy_Heli\Num\logo\LOGO_USAFb.paa"
	...
	class AP_CH53_NAVY_B: AP_CH53
	{
		...
		hiddenSelectionsTextures[]=
		{
			"usarmy_heli\data\CH53\ch53mainB_co.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"USArmy_Heli\Num\decal\NAVYW.paa",
			"USArmy_Heli\Num\logo\LOGO_USAFW.paa"
	...
	class AP_CH34: CH_series
	{
		...
		hiddenSelectionsTextures[]=
		{
			"usarmy_heli\data\ch34\skins\olod\ch34tail_co.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\num\decal\u.s.armyw.paa",
			"usarmy_heli\num\logo\logo_usaf.paa",
			"usarmy_heli\data\ch34\skins\olod\ch34left_co.paa",
			"usarmy_heli\data\ch34\skins\olod\ch34bottom_co.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\ch34\skins\olod\door.paa",
			"usarmy_heli\data\ch34\skins\olod\frame.paa",
			"usarmy_heli\data\ch34\skins\olod\window_l_ca.paa"
		...
		soundEngineOnInt[]=
		{
			"\USArmy_Heli\Sounds\ch34windup.wss",
			0.5,
			1
		};
		soundEngineOnExt[]=
		...
		soundEngineOffInt[]=
		{
			"\USArmy_Heli\Sounds\ch34winddown.wss",
			0.031622801,
			1
		};
		soundEngineOffExt[]=
		...
		class Sounds: Sounds
		{
			class EngineOut
			{
				sound[]=
				{
					"\USArmy_Heli\Sounds\ch34_base_B",
					2,
					1,
					1000
				};
			...
			class RotorHighOut
			{
				sound[]=
				{
					"\USArmy_Heli\Sounds\engine_ch34",
					4,
					1,
					2500
				};
			...
			class EngineIn
			{
				sound[]=
				{
					"\USArmy_Heli\Sounds\ch34_rotors_int_old",
					3.1622777,
					4
				};
				frequency="(randomizer*0.05+0.08)*rpm";
			...
			class RotorsIn
			{
				sound[]=
				{
					"\USArmy_Heli\Sounds\ch34_rotors_int",
					4,
					5
				};
				frequency="(randomizer*0.05+0.08)*rpm";
		...
		class MarkerLights
		{
			...
			{
				name="cab";
				color[]={0.079999998,0,0,0.0099999998};
				ambient[]={0.068000004,0,0,0.1};
				brightness=0.0049999999;
				blinking=0;
			};
			class RedBlinking
			{
		...
		damperSize=4;
		damperForce=0.0049999999;
		damperDamping=0.0049999999;
		class Turrets
		{
			class co_pilot: NewTurret
			{
	...
	class AP_CH34_CL: AP_CH34
	{
		...
		hiddenSelectionsTextures[]=
		{
			"USArmy_Heli\data\ch34\skins\army1\ch34tail_co.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\num\logo\logo_usaf.paa",
			"usarmy_heli\data\ch34\skins\army1\ch34left_co.paa",
			"usarmy_heli\data\ch34\skins\army1\ch34bottom_co.paa",
			"usarmy_heli\num\decal\ARMYw.paa",
			"usarmy_heli\num\decal\u.s.armye.paa",
			"usarmy_heli\data\ch34\skins\army1\door.paa",
			"usarmy_heli\data\ch34\skins\army1\frame.paa",
			"usarmy_heli\data\ch34\skins\army1\window_l_ca.paa"
		};
		class EventHandlers: DefaultEventHandlers
		{
		...
		class AP_CH34_M_G: AP_CH34
	{
		...
		hiddenSelectionsTextures[]=
		{
			"usarmy_heli\data\ch34\skins\army1\ch34tail_M_co.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\num\decal\MARINESw.paa",
			"usarmy_heli\num\logo\logo_usaf.paa",
	...
	class AP_CH34_NAVY_B: AP_CH34
	{
		...
		hiddenSelectionsTextures[]=
		{
			"usarmy_heli\data\ch34\ch34tail_co.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\num\decal\NAVYw.paa",
			"usarmy_heli\num\logo\logo_usafw.paa",
			"usarmy_heli\data\ch34\ch34left_co.paa",
			"usarmy_heli\data\ch34\ch34bottom_co.paa",
			"usarmy_heli\num\decal\ARMYw.paa",
			"usarmy_heli\data\CH53\ch53_ti_ca.paa",
			"usarmy_heli\data\ch34\door.paa",
			"usarmy_heli\data\ch34\frame.paa",
			"usarmy_heli\data\ch34\window_l_ca.paa"
		};
		class EventHandlers: DefaultEventHandlers
		{
			init="_this execVM '\USArmy_Heli\Num\script\Num_white.sqf';";
	...
	class AP_CH34_gunship: AP_CH34_m60
	{
		...
		magazines[] = {"38Rnd_FFAR", "AP_200Rnd_127x99_M2", "AP_200Rnd_127x99_M2", "AP_200Rnd_127x99_M2", "AP_200Rnd_127x99_M2"};
		hiddenSelections[]=
		{
			"camo1",
			"N_1",
		...
		hiddenSelectionsTextures[]=
		{
			...
			"usarmy_heli\data\ch34\skins\olod\frame.paa",
			"usarmy_heli\data\ch34\skins\olod\window_l_ca.paa",
			"usarmy_heli\data\ch34\mk82\mk82_co.paa"			
		};
	...
	class AP_CH34_M_G_gunship: AP_CH34_gunship
	{
		...
		hiddenSelectionsTextures[]=
		{
			...
			"usarmy_heli\data\ch34\skins\army1\frame.paa",
			"usarmy_heli\data\ch34\skins\army1\window_l_ca.paa",
			"usarmy_heli\data\ch34\mk82\mk82_G_co.paa"
		};
		class EventHandlers: DefaultEventHandlers
		{
			init="_this execVM '\USArmy_Heli\Num\script\Num_white.sqf';";
